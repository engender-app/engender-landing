 ...
 *
 * @param {'en' | 'pl'} locale
 * @param {'landing' | 'privacy' | 'guide-getting-started' | 'guide-home' | 'guide-calendar' | 'guide-stats' | 'guide-health' | 'guide-steps' | 'guide-support' | 'guide-media' | 'guide-settings'} page
